...
import 'package:user_career_more/calendar/pages/calendar_page.dart' as _i3;
import 'package:user_career_more/change_password/pages/change_password_page.dart'
    as _i4;
import 'package:user_career_more/core/tab_router.dart' as _i14;
...
import 'package:user_career_more/expect_skills/pages/expect_skills_page.dart'
    as _i10;
import 'package:user_career_more/more/pages/expect_page.dart' as _i8;
import 'package:user_career_more/more/pages/more_page.dart' as _i13;
import 'package:user_career_more/service/pages/service_page.dart' as _i15;
import 'package:user_career_more/update_information/pages/update_information_page.dart'
    as _i17;
import 'package:user_career_more/wallet/pages/wallet_page.dart' as _i18;

abstract class $MoreRouterModule extends _i19.AutoRouterModule {
  @override
  final Map<String, _i19.PageFactory> pagesMap = {
    ...
    ExpectCertificatesRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i6.ExpectCertificatesPage(),
      );
    },
    ExpectExperiencesRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i7.ExpectExperiencesPage(),
      );
    },
    ExpectRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i8.ExpectPage(),
      );
    },
    ExpectPriceServiceRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i9.ExpectPriceServicePage(),
      );
    },
    ExpectSkillsRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i10.ExpectSkillsPage(),
      );
    },
    FilterCategoriesRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i11.FilterCategoriesPage(),
      );
    },
    FilterEditCategoryRoute.name: (routeData) {
      ...
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i12.FilterEditCategoryPage(
          key: args.key,
          expectExperienceResponse: args.expectExperienceResponse,
        ),
      );
    ...
    MoreTabRouter.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i14.MoreTabRouter(),
      );
    },
    ServiceRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i15.ServicePage(),
      );
    },
    UpdateCertificateRoute.name: (routeData) {
      ...
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i16.UpdateCertificatePage(
          key: args.key,
    ...
    UpdateInformationRoute.name: (routeData) {
      return _i19.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i17.UpdateInformationPage(),
      );
    },
...
class AddCertificateRoute extends _i19.PageRouteInfo<void> {
  const AddCertificateRoute({List<_i19.PageRouteInfo>? children})
      : super(
...
class AddExperienceRoute extends _i19.PageRouteInfo<void> {
  const AddExperienceRoute({List<_i19.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i5.EditExperiencePage]
class EditExperienceRoute extends _i19.PageRouteInfo<EditExperienceRouteArgs> {
  EditExperienceRoute({
    _i20.Key? key,
    required _i21.ExpectExperienceResponse expectExperienceResponse,
  ...
  static const _i19.PageInfo<EditExperienceRouteArgs> page =
      _i19.PageInfo<EditExperienceRouteArgs>(name);
}
...
class EditExperienceRouteArgs {
  ...
  final _i21.ExpectExperienceResponse expectExperienceResponse;
...
/// generated route for
/// [_i6.ExpectCertificatesPage]
class ExpectCertificatesRoute extends _i19.PageRouteInfo<void> {
  const ExpectCertificatesRoute({List<_i19.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i7.ExpectExperiencesPage]
class ExpectExperiencesRoute extends _i19.PageRouteInfo<void> {
  const ExpectExperiencesRoute({List<_i19.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i8.ExpectPage]
class ExpectRoute extends _i19.PageRouteInfo<void> {
  const ExpectRoute({List<_i19.PageRouteInfo>? children})
      : super(
          ExpectRoute.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i9.ExpectPriceServicePage]
class ExpectPriceServiceRoute extends _i19.PageRouteInfo<void> {
  const ExpectPriceServiceRoute({List<_i19.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i10.ExpectSkillsPage]
class ExpectSkillsRoute extends _i19.PageRouteInfo<void> {
  const ExpectSkillsRoute({List<_i19.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i11.FilterCategoriesPage]
class FilterCategoriesRoute extends _i19.PageRouteInfo<void> {
  const FilterCategoriesRoute({List<_i19.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i12.FilterEditCategoryPage]
class FilterEditCategoryRoute
    extends _i19.PageRouteInfo<FilterEditCategoryRouteArgs> {
  ...
  static const _i19.PageInfo<FilterEditCategoryRouteArgs> page =
      _i19.PageInfo<FilterEditCategoryRouteArgs>(name);
}
...
/// generated route for
/// [_i14.MoreTabRouter]
class MoreTabRouter extends _i19.PageRouteInfo<void> {
  const MoreTabRouter({List<_i19.PageRouteInfo>? children})
      : super(
          MoreTabRouter.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i15.ServicePage]
class ServiceRoute extends _i19.PageRouteInfo<void> {
  const ServiceRoute({List<_i19.PageRouteInfo>? children})
      : super(
          ServiceRoute.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i16.UpdateCertificatePage]
class UpdateCertificateRoute
    extends _i19.PageRouteInfo<UpdateCertificateRouteArgs> {
  UpdateCertificateRoute({
    _i22.Key? key,
    required _i23.CertificateResponse certificateResponse,
    List<_i19.PageRouteInfo>? children,
  }) : super(
  ...
  static const _i19.PageInfo<UpdateCertificateRouteArgs> page =
      _i19.PageInfo<UpdateCertificateRouteArgs>(name);
}
...
class UpdateCertificateRouteArgs {
  ...
  final _i23.CertificateResponse certificateResponse;
...
/// generated route for
/// [_i17.UpdateInformationPage]
class UpdateInformationRoute extends _i19.PageRouteInfo<void> {
  const UpdateInformationRoute({List<_i19.PageRouteInfo>? children})
      : super(
